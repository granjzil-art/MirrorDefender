...
| `reflection_two_sided_visual` | true | CopyMirrorDefinition | 是否让同一反射面根据观察者所在侧切换实体表面；不改变玩法生效侧 |
...
| `tests/copy_mirror_test.gd` | `SceneTree` | 68 项双网格、玩法联调、内容快照、稳定透明顺序与远距离双观察侧反射回归。 |
